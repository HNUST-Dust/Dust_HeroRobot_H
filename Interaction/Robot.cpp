...
void Robot::Task()
{
    for(;;)
    {
        ...
        if(remote_vt02_.output_.mouse_pr == REMOTE_VT02_KEY_STATUS_FREE)
        {
            remote_angle += (remote_vt02_.output_.mouse_y * PI) * 0.1;
        ...
        else if(remote_vt02_.output_.mouse_pr == REMOTE_VT02_KEY_STATUS_PRESS)
        {
